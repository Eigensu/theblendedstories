      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '20px' }}>
          <img
            ...
            style={{ height: '56px', width: 'auto', mixBlendMode: 'screen', margin: '0 auto', display: 'block' }}
          />
        </div>
        ...
        <p style={{
          ...
          lineHeight: '1.6', marginBottom: '22px', textAlign: 'center',
        }}>
        ...
        {GOOGLE_CONFIGURED ? (
          <GoogleSignInButton
            ...
            onFailed={() => setError('We could not complete your sign-in. Please try again.')}
          />
        ) : (
          <p style={{
            fontFamily: "'Poppins', sans-serif",
        ...
        {error && (
          <p role="alert" style={{
            fontFamily: "'Poppins', sans-serif",
            fontSize: '11.5px', color: '#ff9a9a',
            lineHeight: '1.6', marginTop: '12px', textAlign: 'center',
          }}>
            {error}
          </p>
        )}
        ...
        <p style={{
          ...
          Signing in subscribes you to The Blended Stories newsletter — your invite to
          what&apos;s happening, who&apos;s going, and what not to miss. You can
          unsubscribe anytime.
        </p>
      </div>
    </div>
