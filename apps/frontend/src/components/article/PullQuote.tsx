export default function PullQuote({ quote, author }: { quote: string, author?: string }) {
  return (
    <div style={{ margin: 'clamp(40px, 6vw, 64px) 0', textAlign: 'left', padding: 0 }}>
      ...
      <p style={{ fontFamily: "'Playfair Display', serif", fontStyle: 'italic', fontWeight: 500, fontSize: 'clamp(24px, 4vw, 36px)', lineHeight: 1.45, color: '#f5f4f0', margin: '0 0 24px', maxWidth: '800px' }}>
        "{quote}"
      </p>
