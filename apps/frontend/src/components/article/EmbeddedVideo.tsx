  ...
  return (
    <div style={{ width: '100%', margin: 0, padding: 0 }}>
      <div style={{ aspectRatio: '16/9', border: '1px solid rgba(245,244,240,0.14)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 0 12px', position: 'relative', overflow: 'hidden' }}>
        <OptimizedImage src={thumbnail} alt="" sizes="(max-width: 768px) 100vw, 800px" width={1280} height={720} style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', filter: 'grayscale(0.4) brightness(0.45) contrast(1.1)' }} />
