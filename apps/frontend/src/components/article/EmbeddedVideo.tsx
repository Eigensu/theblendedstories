export default function EmbeddedVideo({ videoUrl, thumbnail }: { videoUrl: string, thumbnail: string }) {
  return (
    <div style={{ maxWidth: '700px', margin: '0 auto', padding: '0 clamp(20px, 4vw, 32px)' }}>
      ...
      <span style={{ display: 'block', fontFamily: "'Public Sans', sans-serif", fontSize: '11px', letterSpacing: '0.06em', color: '#6b6a65', marginBottom: '56px' }}>
