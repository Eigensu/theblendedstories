...
const AGE_OPTIONS = Array.from({ length: 45 - 21 + 1 }, (_, i) =>
  String(21 + i)
);
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Right: image */}
        <div
          className="tbs-nights-success-img"
          style={{
            flex: '0 0 45%',
  ...
  return (
    <div>
      <label style={lbl}>
        {label}
        {req && (
          <span style={{ color: 'rgba(255,255,255,0.35)', marginLeft: '3px' }}>
            *
          </span>
        )}
      </label>
...
export default function TBSNightsPage() {
  ...
  const setVibe = (key: keyof typeof form) => (v: number) =>
    setForm((f) => ({ ...f, [key]: v }));
  ...
  const nextBtnStyle: React.CSSProperties = {
    ...
    gap: '8px',
    border: 'none',
    background: canContinue && !pending ? '#EDE9E1' : 'rgba(237,233,225,0.25)',
    color: 'black',
    padding: '13px 28px',
    borderRadius: '4px',
    fontFamily: "'Poppins', sans-serif",
      ...
      <form
        onSubmit={async (e) => {
          ...
          try {
            ...
            const response = await fetch(`${API_URL}/tbs-nights/waitlist`, {
              method: 'POST',
            ...
            if (!response.ok) {
              ...
              throw new Error(
                data.message || 'Failed to submit waitlist application'
              );
            }
      ...
      >
        ...
        <div className="tbs-wizard-sidebar">
          ...
          <div className="tbs-wizard-desktop-intro">
            ...
            >
              TBS Nights is an invite-only dinner series that brings together
              inspiring people for intentional evenings of great food and even
              better conversation.
            </p>
            <p
              style={{
        ...
        <div className="tbs-wizard-main">
          ...
          <div className="tbs-wizard-content">
            {step === 0 && (
              <div className="form-col">
                ...
                <p style={secSub}>
                  The basics, so we know who we&apos;d be seating.
                </p>
                <div style={fieldCol}>
                  ...
                  <TwoCol>
                    ...
                    <F label="Profession" req>
                      <SearchableDropdown
                        ...
                        onChange={(val) =>
                          setForm((prev) => ({ ...prev, profession: val }))
                        }
                        placeholder="Your answer"
                        required
                      />
            ...
            {step === 1 && (
              <div className="form-col">
                ...
                <div style={{ ...fieldCol, gap: '0' }}>
                  <VibeQ
                    n={1}
                    label="I enjoy conversations that leave me thinking long after the evening ends."
                    value={form.vibe1}
                    onChange={setVibe('vibe1')}
                  />
                  <VibeQ
                    n={2}
                    label="I'd rather meet five interesting strangers than spend another evening with the same group."
                    value={form.vibe2}
                    onChange={setVibe('vibe2')}
                  />
                  <VibeQ
                    n={3}
                    label="I naturally make people around me feel comfortable."
                    value={form.vibe3}
                    onChange={setVibe('vibe3')}
                  />
                  <VibeQ
                    n={4}
                    label="I'm curious about people whose lives, careers or perspectives are completely different from mine."
                    value={form.vibe4}
                    onChange={setVibe('vibe4')}
                  />
                  <VibeQ
                    n={5}
                    label="I enjoy beautiful spaces, thoughtful food and experiences where every detail feels intentional."
                    value={form.vibe5}
                    onChange={setVibe('vibe5')}
                  />
                  <VibeQ
                    n={6}
                    label="The best nights usually happen when nothing is over-planned."
                    value={form.vibe6}
                    onChange={setVibe('vibe6')}
                  />
                  <VibeQ
                    n={7}
                    label="I leave social gatherings feeling more energised than exhausted."
                    value={form.vibe7}
                    onChange={setVibe('vibe7')}
                  />
                </div>
              </div>
            )}
            ...
            {step === 2 && (
              <div className="form-col">
                ...
                <p style={secSub}>
                  Optional, but this is often what gets you a seat.
                </p>
                <div style={fieldCol}>
                  <F label="Tell us something we'd never guess about you.">
                    ...
                    >
                      A favourite restaurant, an unusual hobby, your latest
                      obsession or anything that gives us a better sense of who
                      you are.
                    </p>
                    <textarea
                      rows={3}
                      ...
                      placeholder="Your answer"
                      value={form.somethingElse}
                      onChange={set('somethingElse')}
                    />
                  </F>
                  ...
                  >
                    ...
                    />
                    I&apos;d like to receive updates about future TBS events and
                    gatherings.
                  </label>
                </div>
              </div>
          ...
          <div className="tbs-wizard-nav">
            ...
            <button
              ...
              style={nextBtnStyle}
            >
              {pending && isLastStep && 'Submitting…'}
              {pending && !isLastStep && 'Loading…'}
              {!pending && isLastStep && 'Submit'}
              {!pending && !isLastStep && 'Continue'}
            </button>
          </div>
        </div>
      </form>
